...
/* KSU_NEXT_SUSFS_V113_REMOVED_OLD_CORE_HOOK */
...
int susfs_handle_prctl(unsigned long arg2, unsigned long arg3, unsigned long arg4, unsigned long arg5)
{
	int error = -ENOTSUPP;
#ifdef CONFIG_KSU_SUSFS_SUS_PATH
	...
	if (arg2 == 0x555e1) {
		char ver[] = "1.4.2";
		if (arg3 && copy_to_user((void __user *)arg3, ver, sizeof(ver)))
			return -EFAULT;
		error = 0;
		if (arg5) {
			if (copy_to_user((void __user *)arg5, &error, sizeof(error)))
